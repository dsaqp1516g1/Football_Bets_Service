...
public interface JugadoresDAOQuery {
    ...
    public final static String GET_JUGADORESBYEID = "select hex(equipoid) as equipoid, nombre, dorsal, nacionalidad, valor, nacimiento, fincontrato from jugadores where equipoid=unhex(?)";
